...
const Login = () => {
    ...
    return (
        ...
        <div className="w-full mx-auto my-20 max-w-md p-4 rounded-md shadow sm:p-8 bg-gray-900 text-gray-100">
            ...
            <form onSubmit={handleLogIn} className="space-y-8 ng-untouched ng-pristine ng-valid">
                <div className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <input type="email" name="email" id="email" placeholder="Enter Your Email" className="w-full px-3 py-2 border rounded-md border-gray-700 bg-gray-900 text-gray-100 focus:border-violet-400" />
                    </div>
                    <div className="space-y-2">
